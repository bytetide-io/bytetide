...
const variantStyles: Record<AlertVariant, { container: string; icon: string; title: string; content: string }> = {
  info: {
...
export function Alert({ variant, title, children, className, onDismiss }: AlertProps) {
  ...
  return (
    <div className={clsx('rounded-lg border p-4', styles.container, className)}>
